    ...
    <AnimatePresence>
      {permissionsGateOpen && permissionsGateIntent ? (
        <motion.div
          ...
          className="pointer-events-auto absolute inset-0 z-30 flex items-center justify-center px-4"
          role="presentation"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              'relative z-10 w-full max-w-[26rem] min-w-[18rem] translate-y-[-2.75rem]',
              'overflow-hidden rounded-2xl border border-emerald-500/20',
              'bg-zinc-950/97 shadow-[0_0_0_1px_rgba(16,185,129,0.12)_inset,0_24px_60px_-20px_rgba(0,0,0,0.9)]',
              'backdrop-blur-xl',
            )}
            initial={
              reduceMotion
