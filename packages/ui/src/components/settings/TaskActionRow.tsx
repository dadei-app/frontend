...
import { actionDisplayTitle, formatActionWhen, taskActionMeta } from '@dadei/ui/utils/actionDisplay';
    ...
    <li className="group/action rounded-lg border border-white/7 bg-zinc-950/40 px-3 py-2.5">
      <div className="flex items-start gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-xs text-zinc-500 font-secondary">{taskActionMeta(action)}</p>
        </div>
        <SplitDeleteToolbar
          armed={armed}
          disabled={disabled}
