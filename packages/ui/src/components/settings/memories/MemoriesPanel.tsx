...
import { GridTile, SettingsGrid4 } from '@dadei/ui/components/settings/shared';
...
export function MemoriesPanel() {
  ...
  if (memoriesQuery.isError) {
    ...
    return <p className="text-sm text-rose-300/90 font-secondary">{fetchErr(memoriesQuery.error)}</p>;
    ...
    <SettingsGrid4 className="min-h-0 flex-1">
      ...
      <GridTile col={1} row={1} colSpan={4} rowSpan={2} className="p-3">
        ...
        <MemorySection
          ...
          deletePending={deleteMemoryMutation.isPending}
